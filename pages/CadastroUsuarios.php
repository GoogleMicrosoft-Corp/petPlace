    ...
    <form method="post" enctype="multipart/form-data">
        <fieldset class="fieldset-center lheigth">
            ...
            <div>
                ...
                <input id="txtNome" name="Nome" type="text" class="normalizadorlayout width95porcem" value="<?php if (isset($_SESSION['nome'])) {
                                                                                                                echo $_SESSION['nome'];
                                                                                                            } else {
                                                                                                                echo '';
                                                                                                            } ?>">
            ...
            <div>
                ...
                <input id="txtEmail" name="Email" type="text" class="normalizadorlayout width95porcem" value="<?php if (isset($_SESSION['email'])) {
                                                                                                                    echo $_SESSION['email'];
                                                                                                                } else {
                                                                                                                    echo '';
                                                                                                                } ?>">
